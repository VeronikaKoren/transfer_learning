function [r_cm] = compute_cma_fun(x1,x2,D,u)
%compute cross-mapping for pairs of neurons in trials

                                                                   
J=size(x1,1);                                           % number of trials    
n1=size(x1,2);
n2=size(x2,2);                                           % number of neurons
K=size(x1,3);                                           % number of time steps (length of the signal)
Np=n1*n2;                                           % number of pairs
