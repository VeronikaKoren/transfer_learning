...
%{
savefig=0;
figname=['ccg_bursty_',namei{info_case},'_',sprintf('%1.0i',K)];
...
xlim([0.3,2.7])
%for ii=1:2
%    text(0.1,0.95-(ii-1)*0.08,nameg{ii},'units','normalized','FontName','Arial','fontsize',fs,'color',col{ii})
%end
maxy=max(msyn);
...
set(gca,'YTickLabel',[0.02,0.04],'FontName','Arial','Fontsize',fs)
set(gca,'XTick',[1,2])
set(gca,'XTickLabel',{'bursty','non-bursty'},'XTickLabelRotation',25);
